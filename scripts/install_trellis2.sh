...
echo "or, if you already hold local copies of these weights (e.g. downloaded from"
echo "ModelScope, which mirrors public models without requiring a HF account), point"
echo "at them directly instead of the Hub:"
